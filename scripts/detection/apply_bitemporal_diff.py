...
SITES = {
    ...
    "rybnik_cm":  dict(lat=50.0781, lon=18.5451, tile_id="T34UCA",
                       note="Carbon Mapper source pin — Coal Mining IPCC 1B1a, 6 detections "
                            "1150-2019 kg CH4/hr (Tanager+EMIT). ~6km SSW of original rybnik coords. "
                            "BT enabled to test v8 suppression behaviour at confirmed source location."),
