...
BACKFILL_SITES = {
    ...
    "belchatow":    dict(lat=51.242, lon=19.275, tile_id="T34UCB", skip_bitemporal=True),  # mine centroid (ClimateTrace asset 16168); previously 51.266/19.315 (power station — wrong)
