...
SITES = [
    {
        ...
        "lat": 51.242,   # mine centroid (ClimateTrace asset 16168); was 51.266 (power station — wrong)
        "lon": 19.275,   # mine centroid; was 19.315 (power station — wrong)
        "note": "Bełchatów lignite mine — Europe's #1 CO2 emitter (858 MW, Poland)",
    },
    {
        "name": "lippendorf",
        "tile_id": "T33UUS",
    ...
    # ── Phase 5: JRC top-10 Romanian / Bulgarian lignite sites ───────────────
    {
        "name": "turceni",
        "tile_id": None,
        # Confirmed from catalog search: tiles in search area at 44.101N 23.391E
        "tile_candidates": ["T34TFP", "T34TGP", "T34TFQ", "T34TGQ"],
        "lat": 44.101,
        "lon": 23.391,
        "note": "Turceni lignite plant — Oltenia Energy Complex, ~2,200 MW (Romania)",
    },
    {
        "name": "rovinari",
        "tile_id": None,
        # Confirmed from catalog search: tiles in search area at 44.906N 23.147E
        "tile_candidates": ["T34TFQ", "T34TGQ", "T34TFR", "T34TGR"],
        "lat": 44.906,
        "lon": 23.147,
        "note": "Rovinari lignite plant — Oltenia Energy Complex, ~1,320 MW (Romania)",
    },
    {
        "name": "maritsa_east_2",
        "tile_id": None,
        # Confirmed from catalog search: tiles in search area at 42.271N 26.068E
        "tile_candidates": ["T35TMG", "T35TLG", "T35TMH", "T35TLH"],
        "lat": 42.271,
        "lon": 26.068,
        "note": "Maritsa East 2 — AES-NEK / ContourGlobal, ~1,600 MW lignite (Bulgaria)",
    },
]
